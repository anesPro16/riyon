...
CREATE TABLE `classes` (
  ...
  `teacher_id` char(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `essays` (
  `essay_id` char(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `class_id` char(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `subjects` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Mata Pelajaran',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `essay_questions` (
  ...
  `essay_id` char(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'FK ke pbl_solution_essays.essay_id',
...
--
-- Dumping data for table `essay_submissions`
--
...
CREATE TABLE `exam_answers` (
  `id` varchar(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `attempt_id` varchar(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `question_id` varchar(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `exam_attempts` (
  ...
  `status` enum('ongoing','finished') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'ongoing'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `observation` (
  `observation_id` char(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `class_id` char(26) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `observation_results`
--
...
--
-- Table structure for table `observation_uploads`
--
...
--
-- Dumping data for table `observation_uploads`
--
...
INSERT INTO `orientation` (`id`, `class_id`, `title`, `reflection`, `file_path`, `created_at`) VALUES
...
INSERT INTO `quiz_answers` (`id`, `result_id`, `question_id`, `selected_option`, `is_correct`, `created_at`) VALUES
...
INSERT INTO `quiz_questions` (`question_id`, `quiz_id`, `question_text`, `option_a`, `option_b`, `option_c`, `option_d`, `correct_answer`, `created_at`) VALUES
...
INSERT INTO `quiz_results` (`result_id`, `quiz_id`, `user_id`, `score`, `total_correct`, `total_questions`, `created_at`) VALUES
...
(7, '01K8WA6WVXEKX7JK822G9PVZG9', 7),
(8, '01K8WA6WVXEKX7JK822G9PVZG9', 6),
(9, '01K8WA74MMB7VBRM1Y05NS7GNQ', 6),
(10, '01K8WA74MMB7VBRM1Y05NS7GNQ', 7);
...
--
-- Indexes for table `observation_results`
--
ALTER TABLE `observation_results`
  ADD PRIMARY KEY (`id`),
  ADD KEY `observation_slot_id` (`observation_id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `observation_uploads`
--
ALTER TABLE `observation_uploads`
  ADD PRIMARY KEY (`id`),
  ADD KEY `observation_slot_id` (`observation_id`),
  ADD KEY `user_id` (`user_id`);
...
--
ALTER TABLE `essay_submissions`
  ADD CONSTRAINT `essay_submissions_ibfk_1` FOREIGN KEY (`essay_id`) REFERENCES `essays` (`essay_id`) ON DELETE CASCADE;

--
-- Constraints for table `observation_results`
--
ALTER TABLE `observation_results`
  ADD CONSTRAINT `fk_obs_slot_ibfk_1` FOREIGN KEY (`observation_id`) REFERENCES `observation` (`observation_id`) ON DELETE CASCADE;

--
-- Constraints for table `observation_uploads`
--
ALTER TABLE `observation_uploads`
  ADD CONSTRAINT `fk_obs_slot_ibfk_2` FOREIGN KEY (`observation_id`) REFERENCES `observation` (`observation_id`) ON DELETE CASCADE;

--
-- Constraints for table `orientation`
--
ALTER TABLE `orientation`
  ADD CONSTRAINT `orientation_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
